...
![image-20230831143226786](../assets/二、KNN算法/image-20230831143226786.png)
...
<img src="../assets/二、KNN算法/image-20230831143341119.png" alt="image-20230831143341119" />



![image-20230831143403932](../assets/二、KNN算法/image-20230831143403932.png)

![image-20230831143443988](../assets/二、KNN算法/image-20230831143443988.png)

![image-20230831143436328](../assets/二、KNN算法/image-20230831143436328.png)

![image-20230831143456524](../assets/二、KNN算法/image-20230831143456524.png)

![image-20230831143430741](../assets/二、KNN算法/image-20230831143430741.png)

![image-20230831143503916](../assets/二、KNN算法/image-20230831143503916.png)

![image-20230831143416184](../assets/二、KNN算法/image-20230831143416184.png)



### 【知道】K值的选择

![image-20230831152503338](../assets/二、KNN算法/image-20230831152503338.png)
...
![image-20230831145236097](../assets/二、KNN算法/image-20230831145236097.png)
...
![image-20230831145250261](../assets/二、KNN算法/image-20230831145250261.png)
...
![image-20230831153948263](../assets/二、KNN算法/image-20230831153948263.png)



### 【掌握】曼哈顿距离

![image-20230831154005301](../assets/二、KNN算法/image-20230831154005301.png)

### 【了解】切比雪夫距离

![image-20230831154033908](../assets/二、KNN算法/image-20230831154033908.png)
...
![image-20230831154217579](../assets/二、KNN算法/image-20230831154217579.png)
...
![image-20230831155159883](../assets/二、KNN算法/image-20230831155159883.png)

### 【掌握】归一化

通过对原始数据进行变换把数据映射到【mi,mx】(默认为[0,1])之间

![image-20230831155813699](../assets/二、KNN算法/image-20230831155813699.png)
...
![image-20230831160053298](../assets/二、KNN算法/image-20230831160053298.png)
...
![](../assets/二、KNN算法/0_QHogxF9l4hy0Xxub.png)

每个花的特征用如下属性描述：

![](../assets/二、KNN算法/0_SHhnoaaIm36pc1bd.png)
...
![image-20230831163236810](../assets/二、KNN算法/image-20230831163236810.png)
...
![image-20230831163329892](../assets/二、KNN算法/image-20230831163329892.png)

### 【知道】网格搜索

![image-20230831163559554](../assets/二、KNN算法/image-20230831163559554.png)

![image-20230910154650041](../assets/二、KNN算法/image-20230910154650041.png)

交叉验证网格搜索的API:

![image-20230831163636694](../assets/二、KNN算法/image-20230831163636694.png)
...
![image-20230831164024844](../assets/二、KNN算法/image-20230831164024844.png)
