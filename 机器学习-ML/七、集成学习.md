...
![2021-1](../assets/七、集成学习/2021-1.png) 
...
![2021-2](../assets/七、集成学习/2021-2.png)
...
2)训练分类器
![07.png](../assets/七、集成学习/08.png)

3)平权投票，获取最终结果
![07.png](../assets/七、集成学习/09.png)



4)主要实现过程小结
![07.png](../assets/七、集成学习/10.png)

### 【理解】boosting集成

Boosting 体现了提升思想，每一个训练器重点关注前一个训练器不足的地方进行训练，通过加权投票的方式，得出预测结果。

![](../assets/七、集成学习/11.png)
...
![boosting2](../assets/七、集成学习/boosting2.png)

![boosting3](../assets/七、集成学习/boosting3.png)

![boostin4](../assets/七、集成学习/boostin4.png)

![boosting5](../assets/七、集成学习/boosting5.png)

![boosting6](../assets/七、集成学习/boosting6.png)



![boosting7](../assets/七、集成学习/boosting7.png)
...
![13](../assets/七、集成学习/13.png)
ε<sub>t</sub> 表示第 t 个弱学习器的错误率

**AdaBoost 样本权重更新公式:**

![14](../assets/七、集成学习/14.png)
...
2. 构建第一个基学习器：
   ...
   4. 此时得到：
    ...
    ![16](../assets/七、集成学习/16.png)
    ![17](../assets/七、集成学习/17.png)
...
![18](../assets/七、集成学习/18.png)

![19](../assets/七、集成学习/19.png)

- 构建第三个弱学习器

错误率：0.1820，模型权重：0.7514
![20](../assets/七、集成学习/20.png)

- 强学习器

![21](../assets/七、集成学习/21.png)
...
![23](../assets/七、集成学习/23.png)

则:

![24](../assets/七、集成学习/24.png)

损失函数为平方损失, 则每个样本要拟合的负梯度为:

![26](../assets/七、集成学习/26.png)
...
![28](../assets/七、集成学习/28.png)

- 初始化弱学习器（CART树）

我们通过计算当模型预测值为何值时，会使得第一个基学习器的平方误差最小，即：求损失函数对 f(x<sub>i</sub>) 的导数，并令导数为0.

![29](../assets/七、集成学习/29.png)

![30](../assets/七、集成学习/30.png)

- 构建第一个弱学习器（CART树）

由于我们拟合的是样本的负梯度，即：

![31](../assets/七、集成学习/31.png)

由此得到数据表如下：

![32](../assets/七、集成学习/32.png)
...
![33](../assets/七、集成学习/33.png)



- 构建第二个弱学习器（CART树）

![34](../assets/七、集成学习/34.png)

以 3.5 作为切分点损失最小，构建决策树如下：

![35](../assets/七、集成学习/35.png)

- 构建第三个弱学习器（CART树）

![36](../assets/七、集成学习/36.png)

以 6.5 作为切分点损失最小，构建决策树如下：

![37](../assets/七、集成学习/37.png)

-  最终强学习器

![38](../assets/七、集成学习/38.png)
