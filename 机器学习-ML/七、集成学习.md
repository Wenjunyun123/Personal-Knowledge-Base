...
![06](../assets/七、集成学习/06.png)

1) 采样不同数据集
   ![07](../assets/七、集成学习/07.png)
   
   

2)训练分类器
![08](../assets/七、集成学习/08.png)

3)平权投票，获取最终结果
![09](../assets/七、集成学习/09.png)



4)主要实现过程小结
![10](../assets/七、集成学习/10.png)

### 【理解】boosting集成

Boosting 体现了提升思想，每一个训练器重点关注前一个训练器不足的地方进行训练，通过加权投票的方式，得出预测结果。

![11](../assets/七、集成学习/11.png)
